...
public class RecommendationServiceImpl implements RecommendationService {
    ...
    private String buildMessage(String mood, MoodData.MoodInfo info) {
        return switch (info.getCategory()) {
            case "POSITIVE" -> "You're feeling " + mood.toLowerCase() + "! Let's make the most of this beautiful energy. ✨";
            case "NEGATIVE" -> "It's okay to feel " + mood.toLowerCase() + ". Here's something gentle to help you through. 💙";
            default -> "Here are some things curated just for your mood today. 🌿";
        };
    }

    private ActionLink sp(String q)  { return new ActionLink("Spotify",      "https://open.spotify.com/search/" + q.replace(" ","%20"), "spotify"); }
    private ActionLink yt(String q)  { return new ActionLink("YouTube",      "https://www.youtube.com/results?search_query=" + q.replace(" ","+"), "youtube"); }
    private ActionLink ytm(String q) { return new ActionLink("YouTube Music","https://music.youtube.com/search?q=" + q.replace(" ","+"), "youtube"); }
    private ActionLink savn(String q){ return new ActionLink("JioSaavn",     "https://www.jiosaavn.com/search/" + q.replace(" ","%20"), "jiosaavn"); }
    private ActionLink gaana(String q){return new ActionLink("Gaana",        "https://gaana.com/search/" + q.replace(" ","%20"), "gaana"); }

    private ActionLink nf(String q)  { return new ActionLink("Netflix",      "https://www.netflix.com/search?q=" + q.replace(" ","+"), "netflix"); }
    private ActionLink prime(String q){return new ActionLink("Prime Video",  "https://www.primevideo.com/search/ref=atv_nb_sr?phrase=" + q.replace(" ","+"), "prime"); }
    private ActionLink hs(String q)  { return new ActionLink("Hotstar",      "https://www.hotstar.com/in/search?q=" + q.replace(" ","+"), "hotstar"); }
    private ActionLink imdb(String u){ return new ActionLink("IMDb",         u, "imdb"); }
    private ActionLink trailer(String q){return new ActionLink("Trailer",    "https://www.youtube.com/results?search_query=" + q.replace(" ","+") + "+trailer", "youtube"); }

    private ActionLink swiggy(String q){ return new ActionLink("Swiggy", "https://www.swiggy.com/search?query=" + q.replace(" ","+"), "swiggy"); }
    private ActionLink zomato(String q){ return new ActionLink("Zomato", "https://www.zomato.com/search?q=" + q.replace(" ","+"), "zomato"); }
    private ActionLink maps(String q)  { return new ActionLink("Google Maps","https://www.google.com/maps/search/" + q.replace(" ","+") + "+near+me", "maps"); }
    ...
    private List<RecommendationItem> buildMusic(String mood) {
        return switch (mood) {
            ...
            case "LONELY" -> Arrays.asList(
                ...
                music("Late Night Feelings",     "Honest songs for quiet nights",            "🌙", "late night feelings playlist")
            );
            ...
            case "TIRED" -> Arrays.asList(
                music("Gentle Wake-Up Mix",      "Soft music to ease you into the day",      "🎵", "gentle morning wake up music"),
            ...
            case "BORED" -> Arrays.asList(
                music("Discover Weekly Vibes",   "Fresh tracks you haven't heard yet",       "🎵", "new music discovery 2024"),
            ...
            case "HOPEFUL" -> Arrays.asList(
                ...
                music("Inspirational Hits",      "Music that reminds you anything is possible","✨","inspirational hits playlist"),
                music("New Beginnings",          "Fresh starts deserve fresh sounds",        "🌅", "new beginnings music")
            );
            case "INSECURE" -> Arrays.asList(
                music("Self-Love Playlist",      "Songs that remind you of your worth",      "💜", "self love playlist affirmation"),
    ...
    private List<RecommendationItem> buildMovies(String mood) {
        return switch (mood) {
            case "HAPPY", "EXCITED" -> Arrays.asList(
                movie("La La Land",              "A beautiful story of dreams and love",     "🎬", "la la land", "la la land", "https://www.imdb.com/title/tt3783958/", "la la land"),
                movie("The Secret Life of Walter Mitty","An inspiring adventure about living fully","🎬","walter mitty","walter mitty","https://www.imdb.com/title/tt0359950/","walter mitty"),
                movie("Sing Street",             "A joyful coming-of-age music film",        "🎬", "sing street", "sing street", "https://www.imdb.com/title/tt3544112/", "sing street")
            );
            case "SAD", "DISAPPOINTED", "LONELY" -> Arrays.asList(
                movie("Soul",                    "A heartwarming Pixar film about life's purpose","🎬","soul pixar","soul pixar","https://www.imdb.com/title/tt2948372/","soul pixar"),
                movie("Inside Out",              "A beautiful exploration of emotions",      "🎬", "inside out", "inside out", "https://www.imdb.com/title/tt2096673/", "inside out"),
                movie("Good Will Hunting",       "A moving story about healing and connection","🎬","good will hunting","good will hunting","https://www.imdb.com/title/tt0119217/","good will hunting")
            );
            case "STRESSED", "ANXIOUS", "OVERWHELMED" -> Arrays.asList(
                movie("Chef",                    "A relaxing feel-good movie about passion", "🎬", "chef 2014", "chef 2014", "https://www.imdb.com/title/tt2883512/", "chef 2014"),
                movie("Julie & Julia",           "A comforting story about finding joy",     "🎬", "julie julia", "julie julia", "https://www.imdb.com/title/tt1135503/", "julie julia"),
                movie("The Secret Garden",       "A peaceful, healing story",                "🎬", "secret garden 2020", "secret garden 2020", "https://www.imdb.com/title/tt5774060/", "secret garden 2020")
            );
            case "ANGRY", "FRUSTRATED" -> Arrays.asList(
                movie("Rocky",                   "Channel your fire into something powerful", "🎬", "rocky", "rocky", "https://www.imdb.com/title/tt0075148/", "rocky"),
                movie("Whiplash",                "Intense, cathartic, and deeply satisfying","🎬","whiplash","whiplash","https://www.imdb.com/title/tt2582802/","whiplash"),
                movie("Mad Max: Fury Road",      "Pure adrenaline release",                  "🎬", "mad max fury road", "mad max fury road", "https://www.imdb.com/title/tt1392190/", "mad max fury road")
            );
            case "MOTIVATED", "CONFIDENT", "HOPEFUL" -> Arrays.asList(
                movie("The Pursuit of Happyness","An inspiring true story of resilience",    "🎬","pursuit of happyness","pursuit of happyness","https://www.imdb.com/title/tt0454921/","pursuit of happyness"),
                movie("3 Idiots",                "A fun and motivating Bollywood classic",   "🎬", "3 idiots", "3 idiots", "https://www.imdb.com/title/tt1187043/", "3 idiots"),
                movie("The Social Network",      "Ambition, drive, and building something great","🎬","social network","social network","https://www.imdb.com/title/tt1285016/","social network")
            );
            case "TIRED" -> Arrays.asList(
                movie("My Neighbor Totoro",      "A gentle, magical film to rest your mind", "🎬", "my neighbor totoro", "my neighbor totoro", "https://www.imdb.com/title/tt0096283/", "my neighbor totoro"),
                movie("Spirited Away",           "A dreamy escape into another world",       "🎬", "spirited away", "spirited away", "https://www.imdb.com/title/tt0245429/", "spirited away"),
                movie("Julie & Julia",           "Cozy, warm, and easy to watch",            "🎬", "julie julia", "julie julia", "https://www.imdb.com/title/tt1135503/", "julie julia")
            );
            case "BORED" -> Arrays.asList(
                movie("Knives Out",              "A clever, twisty mystery to keep you hooked","🎬","knives out","knives out","https://www.imdb.com/title/tt8946378/","knives out"),
                movie("The Grand Budapest Hotel","Quirky, colourful, and endlessly entertaining","🎬","grand budapest hotel","grand budapest hotel","https://www.imdb.com/title/tt2278388/","grand budapest hotel"),
                movie("Interstellar",            "Mind-bending sci-fi adventure",            "🎬", "interstellar", "interstellar", "https://www.imdb.com/title/tt0816692/", "interstellar")
            );
            case "RELAXED", "CALM", "PEACEFUL" -> Arrays.asList(
                movie("Princess Mononoke",       "A beautiful, peaceful epic",               "🎬", "princess mononoke", "princess mononoke", "https://www.imdb.com/title/tt0119698/", "princess mononoke"),
                movie("Amélie",                  "A whimsical, warm French classic",         "🎬", "amelie", "amelie", "https://www.imdb.com/title/tt0211915/", "amelie"),
                movie("Chef",                    "Slow, warm, and deeply satisfying",        "🎬", "chef 2014", "chef 2014", "https://www.imdb.com/title/tt2883512/", "chef 2014")
            );
            case "INSECURE" -> Arrays.asList(
                movie("The Devil Wears Prada",   "A story about finding your own strength",  "🎬","devil wears prada","devil wears prada","https://www.imdb.com/title/tt0458352/","devil wears prada"),
                movie("Legally Blonde",          "Proving everyone wrong with confidence",   "🎬","legally blonde","legally blonde","https://www.imdb.com/title/tt0250494/","legally blonde"),
                movie("Billy Elliot",            "Courage to be yourself against all odds",  "🎬","billy elliot","billy elliot","https://www.imdb.com/title/tt0249462/","billy elliot")
            );
            default -> Arrays.asList(
                movie("Forrest Gump",            "A timeless story about life's journey",    "🎬","forrest gump","forrest gump","https://www.imdb.com/title/tt0109830/","forrest gump"),
                movie("The Shawshank Redemption","Hope and resilience at their finest",      "🎬","shawshank redemption","shawshank redemption","https://www.imdb.com/title/tt0111161/","shawshank redemption"),
                movie("Coco",                    "A beautiful story about love and memory",  "🎬","coco pixar","coco pixar","https://www.imdb.com/title/tt2380307/","coco pixar")
            );
        };
    }
    ...
    private List<RecommendationItem> buildPlaces(String mood) {
        return switch (mood) {
            ...
            case "BORED" -> Arrays.asList(
                ...
                place("Night Market / Street Food Area", "Explore local food and culture",          "🌮", "night market street food"),
                place("Bowling Alley / Arcade",  "Fun activities to shake off the dullness",        "🎳", "bowling alley arcade")
            );
            case "TIRED" -> Arrays.asList(
            ...
            case "RELAXED", "CALM", "PEACEFUL" -> Arrays.asList(
                ...
                place("Café with Garden Seating","Outdoor seating, fresh air, good vibes",          "🌿", "cafe garden seating"),
                place("Beach or Lakeside",       "Water has a way of calming everything",           "🏖️", "beach lake")
            );
            case "HOPEFUL", "CONFIDENT" -> Arrays.asList(
                place("Co-working Space / Library","Channel that energy into something productive", "💻", "coworking space library"),
    ...
    private List<RecommendationItem> buildFood(String mood) {
        return switch (mood) {
            case "SAD", "LONELY", "DISAPPOINTED" -> Arrays.asList(
                ...
                food("Hot Chocolate & Desserts", "Sweet treats to lift your spirits",               "🍫", "hot chocolate desserts"),
            ...
            case "HAPPY", "EXCITED" -> Arrays.asList(
                ...
                food("Sushi & Asian Cuisine",    "Fresh, vibrant food for a vibrant mood",          "🍱", "sushi asian cuisine"),
            ...
            case "MOTIVATED", "CONFIDENT" -> Arrays.asList(
                ...
                food("Grilled Chicken & Veggies","Light, nutritious, and energising",               "🍗", "grilled chicken vegetables")
            );
            case "STRESSED", "ANXIOUS", "OVERWHELMED" -> Arrays.asList(
            ...
            case "TIRED" -> Arrays.asList(
                ...
                food("Energy Boosting Meal",     "Protein-rich food to restore your energy",        "⚡", "protein energy meal"),
            ...
            case "HOPEFUL" -> Arrays.asList(
                food("Healthy Breakfast Bowl",   "Start fresh with something nourishing",           "🌅", "healthy breakfast bowl"),
